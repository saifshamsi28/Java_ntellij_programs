...
class BankAccount {
    ...
    public BankAccount(String name,String accNumber,String cardNumber,float currentBalance,int pin){
...
class Main{
    public static void main(String[] args) {
        ...
        BankAccount bank=new BankAccount(name,accNumber,cardNumber,balance,atmPin);
